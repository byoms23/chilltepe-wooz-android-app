...
public class SinistersAdapter extends RecyclerView.Adapter<SinistersAdapter.SinisterTypeViewHolder> {

    @Override
    public SinisterTypeViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View itemView = LayoutInflater.
                from(viewGroup.getContext()).
                inflate(R.layout.item_sinister_event, viewGroup, false);
